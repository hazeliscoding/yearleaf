...
- [ ] Navigation is the single biggest blocker a user hits. Priya, who reads calendars professionally, scrolled down from September expecting October and landed in December, then spent minutes convinced October's weekday columns were misaligned — they were not; she had simply crossed three months without realising, because the layout is three-across. There are no next/previous affordances anywhere, the toolbar reported "July 2026" while October and November filled the screen, and "Fit month" after a year detour landed on May. Everything in the row below is a facet of this
